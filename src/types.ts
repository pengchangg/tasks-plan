...
export interface Task { id: string; childId: string; title: string; description: string; category: string; points: number; repeatRule: RepeatRule; dueDate: string; status: TaskStatus; createdAt: string }
export interface Attachment { name: string; type: 'image' | 'video' }
...
export interface Redemption { id: string; wishId: string; childId: string; pointsCost: number; createdAt: string }
